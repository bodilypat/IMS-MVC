<?php
	...
	if(isset($_POST['saleDetailsItemNumber'])){
		...
		$itemName = htmlentities($_POST['saleItemName']);
		$discount = htmlentities($_POST['saleDiscount']);
		$quantity = htmlentities($_POST['saleQuantity']);
		$unitPrice = htmlentities($_POST['saleUnitPrice']);
		$customerID = htmlentities($_POST['saleCustID']);
		$customerName = htmlentities($_POST['saleCustName']);
