...
const API_URL = 'http://psmedical.com/admin/backend/api/customers.php';
...
// Base URL of your API endpoint (replace with your actual endpoint)
const API_URL = 'http://psmedical.com/admin/backend/api/items.php';
...
// Base URL of your API endpoint (replace with your actual endpoint)
const API_URL = 'http://psmedical.com/admin/backend/api/orders.php';
...
// Base URL of your API endpoint (replace with your actual endpoint)
const API_URL = 'http://psmedical.com/admin/backend/api/vendors.php';
...
// Base URL of your API endpoint (replace with your actual endpoint)
const API_URL = 'http://psmedical.com/admin/backend/api/products.php';
...
// Base URL of your API endpoint (replace with your actual endpoint)
const API_URL = 'http://psmedical.com/admin/backend/api/users.php'; // Replace with actual API URL
