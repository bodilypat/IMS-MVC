	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div id="v-pills-tab" class="nav flex-column nav-pills"  role="tablist" aria-orientation="vertical">
			 	<a id="v-pills-item-tab" href="#v-pills-item" class="nav-link active" data-toggle="pill" role="tab" aria-controls="v-pills-item" aria-selected="true">Item</a>
			  	<a id="v-pills-purchase-tab" href="#v-pills-purchase" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-purchase" aria-selected="false">Purchase</a>
			  	<a id="v-pills-vendor-tab" href="#v-pills-vendor" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Vendor</a>
			  	<a id="v-pills-sale-tab" href="#v-pills-sale" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-sale" aria-selected="false">Sale</a>
			  	<a id="v-pills-customer-tab" href="#v-pills-customer" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-customer" aria-selected="false">Customer</a>
			  	<a id="v-pills-search-tab" href="#v-pills-search" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-search" aria-selected="false">Search</a>
			  	<a id="v-pills-reports-tab" href="#v-pills-reports" class="nav-link" data-toggle="pill" role="tab" aria-controls="v-pills-reports" aria-selected="false">Reports</a>
			</div>
		</div>
		<div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
				  		...
				  		<div class="card-header">Item Details</div>
				  			<div class="card-body">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
										<a href="#itemDetailsTab" class="nav-link active" data-toggle="tab" >Item</a>
									</li>
									<li class="nav-item">
										<a href="#itemImageTab" class="nav-link" data-toggle="tab" >Upload Image</a>
									</li>
								</ul>					
					 ...
					 <form> 
					  <div class="form-row">
						<div class="form-group col-md-6">
						  ...
						  <input type="text" class="form-control" id="custFullName" name="custFullName">
						</div>
						<div class="form-group col-md-2">
							<label for="customerDetailsStatus">Status</label>
							<select id="custStatus" name="custStatus" class="form-control chosenSelect">
								<?php include('include/statusList.html'); ?>
							</select>
						</div>
						 <div class="form-group col-md-3">
							<label for="customerDetailsCustomerID">Customer ID</label>
							<input type="text" class="form-control invTooltip" id="custID" name="custID" title="This will be auto-generated when you add a new customer" autocomplete="off">
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							...
							<input type="text" class="form-control invTooltip" id="custMobile" name="custMobile" title="Do not enter leading 0">
						  </div>
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">Phone 2</label>
							<input type="text" class="form-control invTooltip" id="custPhone2" name="custPhone2" title="Do not enter leading 0">
						  </div>
						  <div class="form-group col-md-6">
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" id="custAddress2" name="custAddress2">
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-6">
						...
						<div class="form-group col-md-4">
						  ...
						  <select id="custDistrict" name="custDistrict" class="form-control chosenSelect">
							<?php include('include/districtList.html'); ?>
						  </select>
						</div>
					  </div>					  
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Item</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#customerSearchTab">Customer</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#saleSearchTab">Sale</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#purchaseSearchTab">Purchase</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#vendorSearchTab">Vendor</a></li>
					</ul>
