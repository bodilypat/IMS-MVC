...
function addCustomer() {
	...
	var custPhone2 = $('#custPhone2').val();
	var custAddress = $('#custAddress').val();
	var custAddress2 = $('#custAddress2').val();
	var custCity = $('#custCity').val();
	var custDistrict = $('#custDistrict option:selected').text();
	var custStatus = $('#custStatus option:selected').text();
	...
	$.ajax({
		...
		complete: function(data){
			populateLastInsertedID(customerLastInsertedIDFile, 'custID');
			searchTableCreator('customerDetailsTableDiv', customerDetailsSearchTableCreatorFile, 'customerDetailsTable');
			reportsTableCreator('customerReportsTableDiv', customerReportsSearchTableCreatorFile, 'customerReportsTable');
		}
	});
